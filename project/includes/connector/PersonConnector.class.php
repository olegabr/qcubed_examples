<?php
	require(__MODEL_CONNECTOR_GEN__ . '/PersonConnectorGen.class.php');
	 ...
	 * must create a new QForm or QPanel which instantiates a PersonModelConnector
	 * class.
	 *
	 ...
	 */
	class PersonConnector extends PersonConnectorGen {
