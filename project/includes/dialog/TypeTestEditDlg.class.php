...
require(__DIALOG_GEN__ . '/TypeTestEditDlgGen.class.php');

/**
 * This is the customizable subclass for the edit dialog. This dialog is just a shell for the
 * TypeTestEditPanel class, and so you will not likely need to do major customizations here.
 ...
 *
 */
class TypeTestEditDlg extends TypeTestEditDlgGen {
	...
	public function __construct($objParent, $strControlId = null) {
		...
		/**
		 * Setting AutoRenderChildren will automatically draw the TypeTestEditPanel panel that is
