...
require(__DIALOG_GEN__ . '/LoginEditDlgGen.class.php');

/**
 * This is the customizable subclass for the edit dialog. This dialog is just a shell for the
 * LoginEditPanel class, and so you will not likely need to do major customizations here.
 ...
 *
 */
class LoginEditDlg extends LoginEditDlgGen {
	...
	public function __construct($objParent, $strControlId = null) {
		...
		/**
		 * Setting AutoRenderChildren will automatically draw the LoginEditPanel panel that is
