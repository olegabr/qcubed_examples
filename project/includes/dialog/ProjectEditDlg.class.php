...
require(__DIALOG_GEN__ . '/ProjectEditDlgGen.class.php');

/**
 * This is the customizable subclass for the edit dialog. This dialog is just a shell for the
 * ProjectEditPanel class, and so you will not likely need to do major customizations here.
 ...
 *
 */
class ProjectEditDlg extends ProjectEditDlgGen {
	...
	public function __construct($objParent, $strControlId = null) {
		...
		/**
		 * Setting AutoRenderChildren will automatically draw the ProjectEditPanel panel that is
