...
require(__DIALOG_GEN__ . '/MilestoneEditDlgGen.class.php');

/**
 * This is the customizable subclass for the edit dialog. This dialog is just a shell for the
 * MilestoneEditPanel class, and so you will not likely need to do major customizations here.
 ...
 *
 */
class MilestoneEditDlg extends MilestoneEditDlgGen {
	...
	public function __construct($objParent, $strControlId = null) {
		...
		/**
		 * Setting AutoRenderChildren will automatically draw the MilestoneEditPanel panel that is
