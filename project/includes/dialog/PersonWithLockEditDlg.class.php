...
require(__DIALOG_GEN__ . '/PersonWithLockEditDlgGen.class.php');

/**
 * This is the customizable subclass for the edit dialog. This dialog is just a shell for the
 * PersonWithLockEditPanel class, and so you will not likely need to do major customizations here.
 ...
 *
 */
class PersonWithLockEditDlg extends PersonWithLockEditDlgGen {
	...
	public function __construct($objParent, $strControlId = null) {
		...
		/**
		 * Setting AutoRenderChildren will automatically draw the PersonWithLockEditPanel panel that is
