 ...
 * subclasses a TypeTest class and can be used to display
 * a collection of TypeTest objects.
 *
...
class TypeTestListGen extends QDataGrid {
	/**
	...
	public function CreateColumns() {
		$this->colId = $this->CreateNodeColumn("Id", QQN::TypeTest()->Id);
		$this->colDate = $this->CreateNodeColumn("Date", QQN::TypeTest()->Date);
		$this->colTime = $this->CreateNodeColumn("Time", QQN::TypeTest()->Time);
		$this->colDateTime = $this->CreateNodeColumn("Date Time", QQN::TypeTest()->DateTime);
		$this->colTestInt = $this->CreateNodeColumn("Test Int", QQN::TypeTest()->TestInt);
		$this->colTestFloat = $this->CreateNodeColumn("Test Float", QQN::TypeTest()->TestFloat);
		$this->colTestText = $this->CreateNodeColumn("Test Text", QQN::TypeTest()->TestText);
		$this->colTestBit = $this->CreateNodeColumn("Test Bit", QQN::TypeTest()->TestBit);
		$this->colTestVarchar = $this->CreateNodeColumn("Test Varchar", QQN::TypeTest()->TestVarchar);
	}
	...
	**/
	public function BindData($objAdditionalCondition = null, $objAdditionalClauses = null) {
		...
		if ($this->Paginator) {
			$this->TotalItemCount = TypeTest::QueryCount($objCondition, $objClauses);
		}
		...
		$this->DataSource = TypeTest::QueryArray($objCondition, $objClauses);
	}
