 ...
 * subclasses a PersonWithLock class and can be used to display
 * a collection of PersonWithLock objects.
 *
...
class PersonWithLockListGen extends QDataGrid {
	/**
	...
	public function CreateColumns() {
		$this->colId = $this->CreateNodeColumn("Id", QQN::PersonWithLock()->Id);
		$this->colFirstName = $this->CreateNodeColumn("First Name", QQN::PersonWithLock()->FirstName);
		$this->colLastName = $this->CreateNodeColumn("Last Name", QQN::PersonWithLock()->LastName);
		$this->colSysTimestamp = $this->CreateNodeColumn("Sys Timestamp", QQN::PersonWithLock()->SysTimestamp);
	}
	...
	**/
	public function BindData($objAdditionalCondition = null, $objAdditionalClauses = null) {
		...
		if ($this->Paginator) {
			$this->TotalItemCount = PersonWithLock::QueryCount($objCondition, $objClauses);
		}
		...
		$this->DataSource = PersonWithLock::QueryArray($objCondition, $objClauses);
	}
