 ...
 * subclasses a Person class and can be used to display
...
class PersonListGen extends QDataGrid {
	/**
	...
	/** @var QHtmlTableNodeColumn */
	public $colLastName;
	/** @var QHtmlTableNodeColumn colLogin */
	public $colLogin;
	...
	public function CreateColumns() {
		$this->colId = $this->CreateNodeColumn("Id", QQN::Person()->Id);
		$this->colFirstName = $this->CreateNodeColumn("First Name", QQN::Person()->FirstName);
		$this->colLastName = $this->CreateNodeColumn("Last Name", QQN::Person()->LastName);
		$this->colLogin = $this->CreateNodeColumn("Login", QQN::Person()->Login);
	}
