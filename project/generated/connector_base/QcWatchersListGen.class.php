 ...
 * subclasses a QcWatchers class and can be used to display
 * a collection of QcWatchers objects.
 *
...
class QcWatchersListGen extends QDataGrid {
	/**
	...
	public function CreateColumns() {
		$this->colTableKey = $this->CreateNodeColumn("Table Key", QQN::QcWatchers()->TableKey);
		$this->colTs = $this->CreateNodeColumn("Ts", QQN::QcWatchers()->Ts);
	}
	...
	**/
	public function BindData($objAdditionalCondition = null, $objAdditionalClauses = null) {
		...
		if ($this->Paginator) {
			$this->TotalItemCount = QcWatchers::QueryCount($objCondition, $objClauses);
		}
		...
		$this->DataSource = QcWatchers::QueryArray($objCondition, $objClauses);
	}
