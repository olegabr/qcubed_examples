 ...
 * subclasses a Milestone class and can be used to display
 * a collection of Milestone objects.
 *
...
class MilestoneListGen extends QDataGrid {
	/**
	...
	public function CreateColumns() {
		$this->colId = $this->CreateNodeColumn("Id", QQN::Milestone()->Id);
		$this->colProject = $this->CreateNodeColumn("Project", QQN::Milestone()->Project);
		$this->colName = $this->CreateNodeColumn("Name", QQN::Milestone()->Name);
	}
	...
	**/
	public function BindData($objAdditionalCondition = null, $objAdditionalClauses = null) {
		...
		if ($this->Paginator) {
			$this->TotalItemCount = Milestone::QueryCount($objCondition, $objClauses);
		}
		...
		$this->DataSource = Milestone::QueryArray($objCondition, $objClauses);
	}
