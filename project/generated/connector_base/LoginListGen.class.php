 ...
 * subclasses a Login class and can be used to display
 * a collection of Login objects.
 *
...
class LoginListGen extends QDataGrid {
	/**
	...
	public function CreateColumns() {
		$this->colId = $this->CreateNodeColumn("Id", QQN::Login()->Id);
		$this->colPerson = $this->CreateNodeColumn("Person", QQN::Login()->Person);
		$this->colUsername = $this->CreateNodeColumn("Username", QQN::Login()->Username);
		$this->colPassword = $this->CreateNodeColumn("Password", QQN::Login()->Password);
		$this->colIsEnabled = $this->CreateNodeColumn("Is Enabled", QQN::Login()->IsEnabled);
	}
