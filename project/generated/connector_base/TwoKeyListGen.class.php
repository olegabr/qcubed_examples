 ...
 * subclasses a TwoKey class and can be used to display
 * a collection of TwoKey objects.
 *
...
class TwoKeyListGen extends QDataGrid {
	/**
	...
	public function CreateColumns() {
		$this->colServer = $this->CreateNodeColumn("Server", QQN::TwoKey()->Server);
		$this->colDirectory = $this->CreateNodeColumn("Directory", QQN::TwoKey()->Directory);
		$this->colFileName = $this->CreateNodeColumn("File Name", QQN::TwoKey()->FileName);
		$this->colPerson = $this->CreateNodeColumn("Person", QQN::TwoKey()->Person);
		$this->colProject = $this->CreateNodeColumn("Project", QQN::TwoKey()->Project);
	}
	...
	**/
	public function BindData($objAdditionalCondition = null, $objAdditionalClauses = null) {
		...
		if ($this->Paginator) {
			$this->TotalItemCount = TwoKey::QueryCount($objCondition, $objClauses);
		}
		...
		$this->DataSource = TwoKey::QueryArray($objCondition, $objClauses);
	}
