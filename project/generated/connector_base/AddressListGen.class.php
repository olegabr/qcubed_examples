 ...
 * subclasses a Address class and can be used to display
...
class AddressListGen extends QDataGrid {
	/**
	...
	public function CreateColumns() {
		$this->colId = $this->CreateNodeColumn("Id", QQN::Address()->Id);
		$this->colPerson = $this->CreateNodeColumn("Person", QQN::Address()->Person);
		$this->colStreet = $this->CreateNodeColumn("Street", QQN::Address()->Street);
		$this->colCity = $this->CreateNodeColumn("City", QQN::Address()->City);
	}
