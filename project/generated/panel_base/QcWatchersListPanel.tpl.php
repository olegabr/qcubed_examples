<?php
	/**
	 * This is a draft template file for the QcWatchersListPanel.
     ...
     * Template property of the QcWatchersListPanel to point to the new location.
	 **/
?>

<?= _r($this->pnlFilter); ?>
<?= _r($this->dtgQcWatcherses); ?>
<?= _r($this->pnlButtons); ?>
