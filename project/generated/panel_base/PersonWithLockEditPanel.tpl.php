<?php
	/**
	 * This is a draft template file for the PersonWithLockEditPanel.
     ...
     * Template property of the PersonWithLockEditPanel to point to the new location.
	 **/
?>
