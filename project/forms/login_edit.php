...
require(__PANEL__ . '/LoginEditPanel.class.php');

/**
 * This is a draft QForm object to do Create, Edit, and Delete functionality
 * of the Login class.  It uses the code-generated
 * LoginConnector class, which has methods to help with
 * easily creating/defining controls to modify the fields of Login columns.
 *
...
//	protected function Form_Load() {}
	...
	protected function CreateButtons() {
		...
		$this->btnDelete->Visible = $this->pnlLogin->mctLogin->EditMode;
	}
	...
	protected function RedirectToListPage() {
		QApplication::Redirect(__VIRTUAL_DIRECTORY__ . __FORMS__ . '/login_list.php');
	}
