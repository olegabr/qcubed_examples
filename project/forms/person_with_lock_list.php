<?php
	...
	require(__PANEL__ . '/PersonWithLockListPanel.class.php');

	/**
	 * This is a draft QForm object to do the List All functionality
	 * of the PersonWithLock class, and is a starting point for the form object.
	 *
	...
	class PersonWithLockListForm extends QForm {
		protected $pnlNav;
		protected $pnlPersonWithLockList;
		...
		protected function Form_Create() {
			...
			$this->pnlPersonWithLockList = new PersonWithLockListPanel($this);
		}
	}
