...
require(__PANEL__ . '/ProjectEditPanel.class.php');

/**
 * This is a draft QForm object to do Create, Edit, and Delete functionality
 * of the Project class.  It uses the code-generated
 * ProjectConnector class, which has methods to help with
 * easily creating/defining controls to modify the fields of Project columns.
 *
...
//	protected function Form_Load() {}
	...
	protected function CreateButtons() {
		...
		$this->btnDelete->Visible = $this->pnlProject->mctProject->EditMode;
	}
	...
	protected function RedirectToListPage() {
		QApplication::Redirect(__VIRTUAL_DIRECTORY__ . __FORMS__ . '/project_list.php');
	}
