<?php
	...
	require(__PANEL__ . '/LoginListPanel.class.php');

	/**
	 * This is a draft QForm object to do the List All functionality
	 * of the Login class, and is a starting point for the form object.
	 *
	...
	class LoginListForm extends QForm {
		...
		protected function Form_Create() {
			...
			$this->pnlLoginList = new LoginListPanel($this);
		}
	}
